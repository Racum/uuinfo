...
- Added option for custom epoch on supported time-based IDs.
...
- Better confidence levels to choose what appears with the --everything flag.
...
- Julid support.
- Display relative time with -r flag.
